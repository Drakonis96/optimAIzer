...
import { clearAgentDocuments } from '../agents/documentTools';
import {
  getBuiltinSkills,
...
agentsRouter.post('/:id/memory/reset', (req: Request, res: Response) => {
  ...
  const clearedDocuments = clearAgentDocuments(userId, agentId);
...
/**
 * GET /api/agents/:id/documents/:fileName
 * Download a document generated by an agent.
 */
agentsRouter.get('/:id/documents/:fileName', (req: Request, res: Response) => {
